...
/* ── Main block container — NEVER wider than viewport ───────────────────── */
...
/* Columns must not push past their container */
[data-testid="column"] {
...
/* ══════════════════════════════════════════════════════════════════════════
   ...
   All: width:100%, max-width:100%, box-sizing:border-box, overflow:hidden
   ══════════════════════════════════════════════════════════════════════════ */
...
def apply_global_styles() -> None:
    """Inject CSS and sidebar brand + nav. Call once per page after set_page_config."""
